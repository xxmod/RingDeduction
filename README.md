...
程序会自动检测截图的宽高比（16:9 / 16:10），但在某些情况下（如 16:10 显示器开启拉伸模式），截图实际像素仍为 16:9，导致自动检测不准确。
...
- `auto`（默认）：根据截图像素自动判断
- `16:9`：1920×1080、2560×1440 等标准 16:9 分辨率
- `16:10`：1920×1200、2560×1600 等 16:10 分辨率，或 16:10 显示器拉伸模式

> **提示：** 程序会自动使用对应的裁剪参数。16:10 拉伸模式下还会将裁剪结果正方化以匹配参考图。
...
- 支持多种宽高比：16:9（1920×1080、2560×1440）、16:10（1920×1200、2560×1600）、4:3（待补充参数）
